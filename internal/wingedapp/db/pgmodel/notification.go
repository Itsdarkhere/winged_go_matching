...
type Notification struct {
	...
	NotificationType null.String `boil:"notification_type" json:"notification_type,omitempty" toml:"notification_type" yaml:"notification_type,omitempty"`
...
var NotificationTableColumns = struct {
	...
	ID:               "notification.id",
	UserRefID:        "notification.user_ref_id",
...
var NotificationWhere = struct {
	...
	UserRefID:        whereHelperstring{field: "\"notification\".\"user_ref_id\""},
	NotificationType: whereHelpernull_String{field: "\"notification\".\"notification_type\""},
	Title:            whereHelpernull_String{field: "\"notification\".\"title\""},
	Message:          whereHelperstring{field: "\"notification\".\"message\""},
	Payload:          whereHelpernull_JSON{field: "\"notification\".\"payload\""},
	ReadAt:           whereHelpernull_Time{field: "\"notification\".\"read_at\""},
	SentAt:           whereHelpertime_Time{field: "\"notification\".\"sent_at\""},
...
func (o *Notification) GetUserRef() *User {
	if o == nil {
		return nil
	}
...
func (r *notificationR) GetUserRef() *User {
	if r == nil {
		return nil
	}
...
var (
	notificationAllColumns            = []string{"id", "user_ref_id", "notification_type", "title", "message", "payload", "read_at", "sent_at", "created_at"}
	notificationColumnsWithoutDefault = []string{"user_ref_id", "message"}
	notificationColumnsWithDefault    = []string{"id", "notification_type", "title", "payload", "read_at", "sent_at", "created_at"}
...
func (q notificationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Notification, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "pgmodel: failed to execute a one query for notification")
	}
...
func (q notificationQuery) All(ctx context.Context, exec boil.ContextExecutor) (NotificationSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "pgmodel: failed to assign all query results to Notification slice")
	}
...
func (q notificationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to count notification rows")
	}
...
func (q notificationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "pgmodel: failed to check if notification exists")
	}
...
func (o *Notification) UserRef(mods ...qm.QueryMod) userQuery {
...
func (notificationL) LoadUserRef(ctx context.Context, e boil.ContextExecutor, singular bool, maybeNotification interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.UserRefNotifications = append(foreign.R.UserRefNotifications, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserRefID == foreign.ID {
				...
				foreign.R.UserRefNotifications = append(foreign.R.UserRefNotifications, local)
				break
			}
		}
	}
...
// SetUserRef of the notification to the related item.
// Sets o.R.UserRef to related.
// Adds o to related.R.UserRefNotifications.
func (o *Notification) SetUserRef(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			UserRefNotifications: NotificationSlice{o},
		}
	} else {
		related.R.UserRefNotifications = append(related.R.UserRefNotifications, o)
	}
...
func FindNotification(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Notification, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "pgmodel: unable to select from notification")
	}
...
func (o *Notification) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("pgmodel: no notification provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "pgmodel: unable to insert into notification")
	}
...
func (o *Notification) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("pgmodel: unable to update notification, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to update notification row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to get rows affected by update for notification")
	}
...
func (q notificationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to update all for notification")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to retrieve rows affected for notification")
	}
...
func (o NotificationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to update all in notification slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to retrieve rows affected all in update all notification")
	}
	return rowsAff, nil
}
...
func (o *Notification) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("pgmodel: no notification provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("pgmodel: unable to upsert notification, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(notificationPrimaryKeyColumns) == 0 {
				return errors.New("pgmodel: unable to upsert notification, could not build conflict column list")
			}

			conflict = make([]string, len(notificationPrimaryKeyColumns))
			copy(conflict, notificationPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"notification\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "pgmodel: unable to upsert notification")
	}
...
func (o *Notification) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("pgmodel: no Notification provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to delete from notification")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to get rows affected by delete for notification")
	}
...
func (q notificationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("pgmodel: no notificationQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to delete all from notification")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to get rows affected by deleteall for notification")
	}
...
func (o NotificationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to delete all from notification slice")
	}
...
func (o *NotificationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "pgmodel: unable to reload all in NotificationSlice")
	}
...
func NotificationExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "pgmodel: unable to check if notification exists")
	}
