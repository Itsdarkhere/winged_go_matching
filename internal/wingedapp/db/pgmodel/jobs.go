...
var JobWhere = struct {
	...
	Payload:     whereHelpernull_JSON{field: "\"jobs\".\"payload\""},
	Result:      whereHelpernull_JSON{field: "\"jobs\".\"result\""},
	Error:       whereHelpernull_String{field: "\"jobs\".\"error\""},
	Attempts:    whereHelperint{field: "\"jobs\".\"attempts\""},
	MaxAttempts: whereHelperint{field: "\"jobs\".\"max_attempts\""},
	CreatedAt:   whereHelpertime_Time{field: "\"jobs\".\"created_at\""},
	StartedAt:   whereHelpernull_Time{field: "\"jobs\".\"started_at\""},
	CompletedAt: whereHelpernull_Time{field: "\"jobs\".\"completed_at\""},
}
...
var (
	jobAllColumns            = []string{"id", "type", "status", "payload", "result", "error", "attempts", "max_attempts", "created_at", "started_at", "completed_at"}
	jobColumnsWithoutDefault = []string{"type"}
	jobColumnsWithDefault    = []string{"id", "status", "payload", "result", "error", "attempts", "max_attempts", "created_at", "started_at", "completed_at"}
...
func (q jobQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Job, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "pgmodel: failed to execute a one query for jobs")
	}
...
func (q jobQuery) All(ctx context.Context, exec boil.ContextExecutor) (JobSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "pgmodel: failed to assign all query results to Job slice")
	}
...
func (q jobQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to count jobs rows")
	}
...
func (q jobQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "pgmodel: failed to check if jobs exists")
	}
...
func FindJob(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Job, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "pgmodel: unable to select from jobs")
	}
...
func (o *Job) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("pgmodel: no jobs provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "pgmodel: unable to insert into jobs")
	}
...
func (o *Job) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("pgmodel: unable to update jobs, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to update jobs row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to get rows affected by update for jobs")
	}
...
func (q jobQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to update all for jobs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to retrieve rows affected for jobs")
	}
...
func (o JobSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to update all in job slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to retrieve rows affected all in update all job")
	}
	return rowsAff, nil
}
...
func (o *Job) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("pgmodel: no jobs provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("pgmodel: unable to upsert jobs, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(jobPrimaryKeyColumns) == 0 {
				return errors.New("pgmodel: unable to upsert jobs, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "pgmodel: unable to upsert jobs")
	}
...
func (o *Job) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("pgmodel: no Job provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to delete from jobs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to get rows affected by delete for jobs")
	}
...
func (q jobQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("pgmodel: no jobQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to delete all from jobs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: failed to get rows affected by deleteall for jobs")
	}
...
func (o JobSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "pgmodel: unable to delete all from job slice")
	}
...
func (o *JobSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "pgmodel: unable to reload all in JobSlice")
	}
...
func JobExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "pgmodel: unable to check if jobs exists")
	}
